...
/**
 * Value Object: Social Security Number (Swiss AHV number).
...
public final class SocialSecurityNumber {
    ...
    public SocialSecurityNumber(String raw) {
        ...
        if (digits.length() != 13) {
            throw new IllegalArgumentException(
                    "Social security number must have 13 digits: " + raw);
        }
        if (!digits.startsWith("756")) {
            throw new IllegalArgumentException(
                    "Social security number must start with 756: " + raw);
        }
        if (!validateEan13(digits)) {
            throw new IllegalArgumentException(
                    "Social security number has invalid check digit: " + raw);
        }
        this.value = digits;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SocialSecurityNumber other)) return false;
