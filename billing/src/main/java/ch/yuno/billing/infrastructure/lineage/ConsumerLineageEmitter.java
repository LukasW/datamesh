package ch.yuno.billing.infrastructure.lineage;
 ...
 * Declares which topics billing-service consumes and which local tables it materializes.
 */
@ApplicationScoped
public class ConsumerLineageEmitter {
    ...
    void onStart(@Observes StartupEvent event) {
        try {
            ...
            emitConsumerLineage(client, ol, "billing-policy-issued-consumer",
                    "policy.v1.issued", "billing_db.public.policy_holder");
            emitConsumerLineage(client, ol, "billing-policy-cancelled-consumer",
                    "policy.v1.cancelled", "billing_db.public.policy_holder");
            emitConsumerLineage(client, ol, "billing-partner-state-consumer",
                    "person.v1.state", "billing_db.public.policyholder_view");
            emitConsumerLineage(client, ol, "billing-claims-settled-consumer",
                    "claims.v1.settled", "billing_db.public.payout");
